...
const NAV_ITEMS: { to: string, icon: ReactNode, tKey: TranslationKey }[] = [
  { to: '/',           icon: <DashIcon />,      tKey: 'dashboard'  },
  { to: '/analytics',  icon: <AnalyticsIcon />, tKey: 'analytics' },
  { to: '/clients',    icon: <ClientsIcon />,   tKey: 'clients'    },
  { to: '/projects',   icon: <ProjectsIcon />,  tKey: 'projects'   },
  { to: '/calendar',   icon: <CalendarIcon />,  tKey: 'calendar'   },
  { to: '/payments',   icon: <PaymentsIcon />,  tKey: 'payments'   },
  { to: '/tasks',      icon: <TasksIcon />,     tKey: 'tasks'      },
  { to: '/settings',   icon: <SettingsIcon />,  tKey: 'settings'   },
]
